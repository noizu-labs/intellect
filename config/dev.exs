...
config :noizu_intellect, Noizu.IntellectWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "derCRiqeG/526vRZxxZ5gSY3OxU8pkBeRPANqyMugi+hRL/6BBmhXEoIPzrIPULq",
  watchers: [
...
config :noizu_intellect, Noizu.IntellectWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/noizu_intellect_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :noizu_intellect, dev_routes: true
